...
void main ()
{
  lowp vec4 c_1;
  lowp vec4 tmpvar_2;
  tmpvar_2 = (texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  lowp vec4 c_3;
...
void main ()
{
  lowp vec4 c_1;
  lowp vec4 tmpvar_2;
  tmpvar_2 = (texture (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  lowp vec4 c_3;
  c_3.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * (max (0.0, 
    dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)
  ) * 2.0));
...
{
  lowp vec4 c_1;
  c_1.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c_1.w = 0.15;
  gl_FragData[0] = c_1;
}
...
{
  lowp vec4 c_1;
  c_1.xyz = ((texture (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * (2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c_1.w = 0.15;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_2 = tmpvar_7;
  c_1.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_2 * 2.0))));
  c_1.w = 0.15;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_2 = tmpvar_4;
  c_1.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_2 * 2.0))));
  c_1.w = 0.15;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_5 = (_LightShadowData.x + (tmpvar_4 * (1.0 - _LightShadowData.x)));
  shadow_2 = tmpvar_5;
  c_1.xyz = ((texture (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * min ((2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_2 * 2.0))));
  c_1.w = 0.15;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec4 light_3;
  lowp vec4 tmpvar_4;
  tmpvar_4 = (texture (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  lowp vec4 tmpvar_5;
...
void main ()
{
  ...
  lowp vec4 tmpvar_7;
  tmpvar_7 = (texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  lowp vec4 tmpvar_8;
...
void main ()
{
  ...
  mediump vec4 light_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = (texture (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  lowp vec4 tmpvar_8;
