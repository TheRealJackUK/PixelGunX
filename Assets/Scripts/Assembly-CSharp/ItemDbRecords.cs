...
public static class ItemDbRecords
{
	public static List<ItemRecord> GetRecords()
	{
		...
		// AdvancedScoutRifle
		list.Add(new ItemRecord(218, "AdvancedScoutRifle", "AdvancedScoutRifle", "Weapon278", "AdvancedScoutRifle", "AdvancedScoutRifle", int.MaxValue, false, true, "GemsCurrency"));
		list.Add(new ItemRecord(282, "PixelStrikeRifle", "PixelStrikeRifle", "Weapon282", "PixelStrikeRifle", "PixelStrikeRifle", 600, true, false, "Coins"));
		list.Add(new ItemRecord(288, "golduzi", "golduzi", "Weapon288", "golduzi", "golduzi", 150, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(289, "vector", "vector", "Weapon289", "vector", "vector", 300, true, false, "Coins"));
		list.Add(new ItemRecord(290, "redshotgun", "redshotgun", "Weapon290", "redshotgun", "redshotgun", 550, true, false, "Coins"));
		list.Add(new ItemRecord(291, "goldak", "goldak", "Weapon291", "goldak", "goldak", 700, true, false, "Coins"));
		list.Add(new ItemRecord(279, "OGUzi", "OGUzi", "Weapon279", "OGUzi", "OGUzi", 150, true, false, "Coins"));
		list.Add(new ItemRecord(280, "Nokia", "Nokia", "Weapon280", "Nokia", "Nokia", 420, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(395, "GiantSword", "GiantSword", "Weapon395", "GiantSword", "GiantSword", 150, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(399, "TigerThing", "TigerThing", "Weapon399", "TigerThing", "TigerThing", 125, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(404, "PiratBlunderbuss", "PiratBlunderbuss", "Weapon404", "PiratBlunderbuss", "PiratBlunderbuss", 75, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(403, "PiratPistols", "PiratPistols", "Weapon403", "PiratPistols", "PiratPistols", 150, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(406, "PirateMusket", "PirateMusket", "Weapon406", "PirateMusket", "PirateMusket", 350, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(284, "R01", "R01", "Weapon284", "R01", "R01", 250, true, false, "Coins"));
		list.Add(new ItemRecord(285, "ioncannon", "ioncannon", "Weapon285", "ioncannon", "ioncannon", 200, true, false, "GemsCurrency"));
		//list.Add(new ItemRecord(286, "bg3dchainsaw", "bg3dchainsaw", "Weapon286", "bg3dchainsaw", "bg3dchainsaw", 50, false, true, "GemsCurrency"));
		list.Add(new ItemRecord(287, "teslapack", "teslapack", "Weapon287", "teslapack", "teslapack", 500, true, false, "Coins"));
		list.Add(new ItemRecord(292, "FlashlightGun", "FlashlightGun", "Weapon292", "FlashlightGun", "FlashlightGun", 1, true, false, "Coins"));
		list.Add(new ItemRecord(283, "bg3dcodrailgun", "bg3dcodrailgun", "Weapon283", "bg3dcodrailgun", "bg3dcodrailgun", 250, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(436, "NightHunter", "NightHunter", "Weapon436", "NightHunter", "NightHunter", 400, true, false, "Coins"));
		list.Add(new ItemRecord(437, "Casanova", "Casanova", "Weapon437", "Casanova", "Casanova", 250, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(438, "Veteran", "Veteran", "Weapon438", "Veteran", "Veteran", 150, true, false, "Coins"));
		list.Add(new ItemRecord(439, "SeriousArgument", "SeriousArgument", "Weapon439", "SeriousArgument", "SeriousArgument", 300, true, false, "Coins"));
		list.Add(new ItemRecord(424, "FreezerGun", "FreezerGun", "Weapon424", "FreezerGun", "FreezerGun", 450, true, false, "Coins"));
		list.Add(new ItemRecord(423, "GoldenTrident", "GoldenTrident", "Weapon423", "GoldenTrident", "GoldenTrident", 500, true, false, "Coins"));
		list.Add(new ItemRecord(422, "KryptBlaster", "KryptBlaster", "Weapon422", "KryptBlaster", "KryptBlaster", 350, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(426, "GreenLantern", "GreenLantern", "Weapon426", "GreenLantern", "GreenLantern", 300, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(407, "SeaCannon", "SeaCannon", "Weapon407", "SeaCannon", "SeaCannon", 400, true, false, "Coins"));
		list.Add(new ItemRecord(402, "PiratSword", "PiratSword", "Weapon402", "PiratSword", "PiratSword", 150, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(408, "LightSwords", "LightSwords", "Weapon408", "LightSwords", "LightSwords", 300, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(409, "DarkSwords", "DarkSwords", "Weapon409", "DarkSwords", "DarkSwords", 250, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(281, "PiratSword2", "PiratSword2", "Weapon281", "PiratSword2", "PiratSword2", 550, true, false, "Coins"));
		list.Add(new ItemRecord(428, "ElecGlove", "ElecGlove", "Weapon428", "ElecGlove", "ElecGlove", 75, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(397, "DragonCannon", "DragonCannon", "Weapon397", "DragonCannon", "DragonCannon", 150, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(430, "LuckyShotgun", "LuckyShotgun", "Weapon430", "LuckyShotgun", "LuckyShotgun", 350, true, false, "Coins"));
		list.Add(new ItemRecord(434, "BodySnatcher", "BodySnatcher", "Weapon434", "BodySnatcher", "BodySnatcher", 650, true, false, "Coins"));
		list.Add(new ItemRecord(398, "FireworkBow", "FireworkBow", "Weapon398", "FireworkBow", "FireworkBow", 450, true, false, "Coins"));
		list.Add(new ItemRecord(425, "GreenBow", "GreenBow", "Weapon425", "GreenBow", "GreenBow", 350, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(400, "BlueDragon", "BlueDragon", "Weapon400", "BlueDragon", "BlueDragon", 300, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(427, "FlyTrap", "FlyTrap", "Weapon427", "FlyTrap", "FlyTrap", 400, true, false, "Coins"));
		list.Add(new ItemRecord(435, "RabbitPistols", "RabbitPistols", "Weapon435", "RabbitPistols", "RabbitPistols", 250, true, false, "Coins"));
		...
		list.Add(new ItemRecord(405, "PirateFlamer", "PirateFlamer", "Weapon405", "PirateFlamer", "PirateFlamer", 450, true, false, "Coins"));
