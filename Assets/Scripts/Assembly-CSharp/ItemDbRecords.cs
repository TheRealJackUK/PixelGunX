...
public static class ItemDbRecords
{
	public static List<ItemRecord> GetRecords()
	{
		...
		list.Add(new ItemRecord(284, "R01", "R01", "Weapon284", "R01", "R01", 350, true, false, "Coins"));
		list.Add(new ItemRecord(285, "ioncannon", "ioncannon", "Weapon285", "ioncannon", "ioncannon", 800, true, false, "GemsCurrency"));
		//list.Add(new ItemRecord(286, "bg3dchainsaw", "bg3dchainsaw", "Weapon286", "bg3dchainsaw", "bg3dchainsaw", 50, false, true, "GemsCurrency"));
		list.Add(new ItemRecord(287, "teslapack", "teslapack", "Weapon287", "teslapack", "teslapack", 500, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(42069, "FlashlightGun", "FlashlightGun", "Weapon42069", "FlashlightGun", "FlashlightGun", 1, true, false, "Coins"));
		...
		list.Add(new ItemRecord(439, "SeriousArgument", "SeriousArgument", "Weapon439", "SeriousArgument", "SeriousArgument", 800, true, false, "Coins"));
		list.Add(new ItemRecord(424, "FreezerGun", "FreezerGun", "Weapon424", "FreezerGun", "FreezerGun", 750, true, false, "Coins"));
		list.Add(new ItemRecord(423, "GoldenTrident", "GoldenTrident", "Weapon423", "GoldenTrident", "GoldenTrident", 900, true, false, "Coins"));
		list.Add(new ItemRecord(422, "KryptBlaster", "KryptBlaster", "Weapon422", "KryptBlaster", "KryptBlaster", 500, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(426, "GreenLantern", "GreenLantern", "Weapon426", "GreenLantern", "GreenLantern", 550, true, false, "GemsCurrency"));
		...
		list.Add(new ItemRecord(398, "FireworkBow", "FireworkBow", "Weapon398", "FireworkBow", "FireworkBow", 750, true, false, "Coins"));
		list.Add(new ItemRecord(425, "GreenBow", "GreenBow", "Weapon425", "GreenBow", "GreenBow", 350, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(400, "BlueDragon", "BlueDragon", "Weapon400", "BlueDragon", "BlueDragon", 550, true, false, "GemsCurrency"));
		list.Add(new ItemRecord(427, "FlyTrap", "FlyTrap", "Weapon427", "FlyTrap", "FlyTrap", 700, true, false, "Coins"));
