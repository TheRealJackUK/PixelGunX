...
public class ConnectSceneNGUIController : MonoBehaviour
{
	...
	public static string[] masMapName = new string[52]
	{
		...
		"survival_3", "facility", "Shipyard", "High Noon", "Frontier", "Pirate Cove"
	};
	...
	public static string[] masMapNameCompany = new string[43]
	{
		...
		"survival_3", "facility", "High Noon", "Frontier", "Pirate Cove"
	};
	...
	private void HandleCreateRoomBtnClicked(object sender, EventArgs e)
	{
		...
		if (true)
		{
			...
			PhotonNetwork.CreateRoom(text, 10, hashtable, array);
