...
public class ConnectSceneNGUIController : MonoBehaviour
{
	...
	public static string[] masMapName = new string[33]
	{
	...
	public static string[] masMapNameCompany = new string[33]
	{
		...
		"Christmas_dinner", "Secret_Base", "Helicarrier"
	};
