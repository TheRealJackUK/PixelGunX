...
public class ConnectSceneNGUIController : MonoBehaviour
{
	...
	public static string[] masMapName = new string[28]
	{
		...
		"Coliseum_MP", "Bridge", "Jail", "Slender_Multy", "Train", "DevScene", "Pool_Abandoned", "Lean_Matrix"
	};
	...
	public static string[] masMapNameCompany = new string[26]
	{
		...
		"Assault", "Aztec", "Dust", "Sky_islands", "NuclearCity", "Lean_Matrix"
	};
