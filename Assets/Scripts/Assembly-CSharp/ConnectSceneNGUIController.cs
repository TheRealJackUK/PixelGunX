...
public class ConnectSceneNGUIController : MonoBehaviour
{
	...
	public static string[] masMapName = new string[46]
	{
		"Paradise", "RunAndJump", "Pizza", "Christmas_Town", "level_0", "level_1", "level_4", "level_5", "NuclearCity", "Supermarket", "Sky_islands", "Sniper", "Knife", "Heaven", "Hill",
		...
		"emperors_palace", "Helicarrier", "train_robbery", "Candyland", "epilepsy", "AntsButBetter", "RealCube", "ExtremelyReal"
	};
	...
	public static string[] masMapNameCompany = new string[38]
	{
		...
		"Christmas_dinner", "Secret_Base", "Helicarrier", "train_robbery", "Candyland", "AntsButBetter", "ExtremelyReal"
	};
