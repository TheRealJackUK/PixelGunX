...
public class ConnectSceneNGUIController : MonoBehaviour
{
	...
	public static string[] masMapName = new string[40]
	{
		...
		"emperors_palace", "Helicarrier", "train_robbery", "Candyland", "epilepsy", "AntsButBetter", "RealCube"
	};
	...
	public static string[] masMapNameCompany = new string[37]
	{
		...
		"Christmas_dinner", "Secret_Base", "Helicarrier", "train_robbery", "Candyland", "AntsButBetter"
	};
