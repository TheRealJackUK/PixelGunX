...
public class ConnectSceneNGUIController : MonoBehaviour
{
	...
	public static string[] masMapName = new string[27]
	{
		...
		"Coliseum_MP", "Bridge", "Jail", "Slender_Multy", "Train", "DevScene", "Pool_Abandoned"
	};
	...
	public static string[] masMapNameCompany = new string[25]
	{
		...
		"Assault", "Aztec", "Dust", "Sky_islands", "NuclearCity"
	};

	public static string[] masMapNameflag = new string[14]
	{
		"Two_Castles", "Barge", "Bota", "Paradise", "Parkour", "NuclearCity", "Day_D", "Ants", "Underwater", "Matrix",
		"Portal", "Space", "Dust", "Ships"
	};
