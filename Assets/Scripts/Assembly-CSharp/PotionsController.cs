...
public sealed class PotionsController : MonoBehaviour
{
	...
	static PotionsController()
	{
		...
		potionDurations.Add("InvisibilityPotion0", 60f);
		potionDurations.Add(GearManager.Turret + "0", 120f);
		potionDurations.Add(GearManager.Jetpack + "0", 60f);
		potionDurations.Add(GearManager.Mech + "0", 120f);
		potionDurations.Add("InvisibilityPotion1", 65f);
		potionDurations.Add(GearManager.Turret + "1", 120f);
		potionDurations.Add(GearManager.Jetpack + "1", 65f);
		potionDurations.Add(GearManager.Mech + "1", 120f);
		potionDurations.Add("InvisibilityPotion2", 70f);
		potionDurations.Add(GearManager.Turret + "2", 120f);
		potionDurations.Add(GearManager.Jetpack + "2", 70f);
		potionDurations.Add(GearManager.Mech + "2", 120f);
		potionDurations.Add("InvisibilityPotion3", 75f);
		potionDurations.Add(GearManager.Turret + "3", 120f);
		potionDurations.Add(GearManager.Jetpack + "3", 75f);
		potionDurations.Add(GearManager.Mech + "3", 120f);
		potionDurations.Add("InvisibilityPotion4", 80f);
		potionDurations.Add(GearManager.Turret + "4", 120f);
		potionDurations.Add(GearManager.Jetpack + "4", 80f);
		potionDurations.Add(GearManager.Mech + "4", 120f);
		potionDurations.Add("InvisibilityPotion5", 85f);
		potionDurations.Add(GearManager.Turret + "5", 120f);
		potionDurations.Add(GearManager.Jetpack + "5", 90f);
		potionDurations.Add(GearManager.Mech + "5", 120f);
	}
