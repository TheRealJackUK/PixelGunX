...
public class CameraSceneController : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		else if (Application.loadedLevelName.Equals("facility"))
		{
			posCam = new Vector3(11.4502f, 20.29328f, 19.8833f);
			rotateCam = Quaternion.Euler(new Vector3(32.95062f, -149.9998f, 0f));
		}
		...
		else if (Application.loadedLevelName.Equals("Warehouse"))
		{
			posCam = new Vector3(-44.764f, 21.7f, 30.13f);
			rotateCam = Quaternion.Euler(new Vector3(19.81203f, 131.8383f, -2.086029f));
		}
		...
		else if (Application.loadedLevelName.Equals("ExtremelyReal"))
		{
			posCam = new Vector3(42.8f, 4.5f, -29.2f);
			rotateCam = Quaternion.Euler(new Vector3(-6.537048f, 130.2239f, 2.148402e-07f));
		}
		else if (Application.loadedLevelName.Equals("RunAndJump"))
		{
		...
		else if (Application.loadedLevelName.Equals("level_3"))
		{
			...
			rotateCam = Quaternion.Euler(new Vector3(21.24496f, -30.50543f, 1.537313f));
		}
		...
		else if (Application.loadedLevelName.Equals("Backrooms"))
		{
			posCam = new Vector3(0, 0.5f, 0f);
			rotateCam = Quaternion.Euler(new Vector3(0f, 0f, 0f));
		}
		else if (Application.loadedLevelName.Equals("Computer"))
		{
			posCam = new Vector3(0, 12.8f, 22.9f);
			rotateCam = Quaternion.Euler(new Vector3(0f, -180f, 0f));
		}
	}
