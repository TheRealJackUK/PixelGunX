...
public sealed class ChatViewrController : MonoBehaviour
{
	...
	public void postChat(string _text)
	{
		...
		ChatWebhook.instance.SendMessagee(_text.Replace("@", "[at]"), PlayerObject.GetComponent<Player_move_c>()._weaponManager.myTable.GetComponent<NetworkStartTable>().NamePlayer);
	}
