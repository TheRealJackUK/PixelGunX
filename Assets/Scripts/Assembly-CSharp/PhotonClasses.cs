...
namespace Photon
{
    ...
    /// <summary>
    /// This class adds the property photonView, while logging a warning when your game still uses the PhotonView.
    /// </summary>
    public class MonoBehaviour : UnityEngine.MonoBehaviour
    {
        ...
        /// Try to modify PhotonView with a if-def condition:
        ///
        /// #if UNITY_EDITOR
        /// new
        /// #endif
        ...
        public new PhotonView PhotonView
        {
            get
            {
                Debug.LogWarning("Why are you still using PhotonView? should be PhotonView?");
