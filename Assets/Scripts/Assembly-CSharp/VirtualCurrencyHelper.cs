...
public sealed class VirtualCurrencyHelper
{
	...
	static VirtualCurrencyHelper()
	{
		...
		AddPrice(StoreKitEventListener.skin931_3, 25);
		AddPrice(StoreKitEventListener.skin931_4, 25);
		AddPrice(StoreKitEventListener.skin931_5, 25);
		AddPrice(StoreKitEventListener.skin931_6, 25);
		...
		AddPrice(Wear.hat_Army_1, 35);
		AddPrice(Wear.hat_Army_2, 35);
		AddPrice(Wear.hat_Army_3, 35);
		AddPrice(Wear.hat_Army_4, 35);
		AddPrice(Wear.hat_Steel_1, 42);
		AddPrice(Wear.hat_Steel_2, 42);
		AddPrice(Wear.hat_Steel_3, 42);
		AddPrice(Wear.hat_Steel_4, 42);
		AddPrice(Wear.hat_Royal_1, 50);
		AddPrice(Wear.hat_Royal_2, 50);
		AddPrice(Wear.hat_Royal_3, 50);
		AddPrice(Wear.hat_Royal_4, 50);
		AddPrice(Wear.hat_Almaz_1, 60);
		AddPrice(Wear.hat_Almaz_2, 60);
		AddPrice(Wear.hat_Almaz_3, 60);
		AddPrice(Wear.hat_Almaz_4, 60);
		...
		AddPrice(Wear.Armor_Army_1, 35);
		AddPrice(Wear.Armor_Army_2, 35);
		AddPrice(Wear.Armor_Army_3, 35);
		AddPrice(Wear.Armor_Steel, 42);
		AddPrice(Wear.Armor_Steel_2, 42);
		AddPrice(Wear.Armor_Steel_3, 42);
		AddPrice(Wear.Armor_Royal_1, 50);
		AddPrice(Wear.Armor_Royal_2, 50);
		AddPrice(Wear.Armor_Royal_3, 50);
		AddPrice(Wear.Armor_Almaz_1, 60);
		AddPrice(Wear.Armor_Almaz_2, 60);
		AddPrice(Wear.Armor_Almaz_3, 60);
		AddPrice(Wear.Armor_Army_4, 60);
		AddPrice(Wear.Armor_Steel_4, 60);
		AddPrice(Wear.Armor_Royal_4, 67);
		AddPrice(Wear.Armor_Almaz_4, 60);
		AddPrice(Wear.Armor_Adamant_3, 3);
		AddPrice(Wear.Armor_Rubin_1, 67);
		AddPrice(Wear.Armor_Rubin_2, 67);
		AddPrice(Wear.Armor_Rubin_3, 67);
		AddPrice(Wear.hat_Rubin_1, 67);
		AddPrice(Wear.hat_Rubin_2, 67);
		AddPrice(Wear.hat_Rubin_3, 67);
		AddPrice(Wear.Armor_Adamant_Const_1, 85);
		AddPrice(Wear.Armor_Adamant_Const_2, 85);
		AddPrice(Wear.Armor_Adamant_Const_3, 85);
		AddPrice(Wear.hat_Adamant_Const_1, 85);
		AddPrice(Wear.hat_Adamant_Const_2, 85);
		AddPrice(Wear.hat_Adamant_Const_3, 85);
		for (int i = 0; i < 11; i++)
		{
